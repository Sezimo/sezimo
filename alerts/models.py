...
class Notification(models.Model):
    ...
    COLOR_CHOICES = [('primary', 'primary '), ('success', 'success'),
                     ('warning', 'warning'), ('danger', 'danger')]

    admin_panel_name = models.CharField(
    ...
    # replace this with a WYSIWYG later
    body = models.TextField(blank=False, null=False)
    app = models.CharField(max_length=30, null=True, blank=True, choices=get_apps(
    ), help_text="Which app to show announcement on. None will show on all.")
